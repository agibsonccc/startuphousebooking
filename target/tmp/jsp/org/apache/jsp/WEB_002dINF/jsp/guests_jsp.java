...
public final class guests_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script>\n");
      out.write("\tEntity = {\n");
      out.write("\t\tname : \"guest\",\n");
      out.write("\t\tmodel : function(options) {\n");
      out.write("\t\t\treturn new Guest(options);\n");
      out.write("\t\t},\n");
      out.write("\t\tcollection : function(options) {\n");
      out.write("\t\t\treturn new Guests( {}, options );\n");
      out.write("\t\t},\n");
      out.write("\t\teditView : function(options) {\n");
      out.write("\t\t\treturn new EditGuestView(options);\n");
      out.write("\t\t},\n");
      ...
      out.write("</div>\n");
      out.write("\n");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "templates/guest.mustache.jsp", out, false);
      out.write('\n');
  ...
  private boolean _jspx_meth_s_text_1(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_1.setName("guests");
