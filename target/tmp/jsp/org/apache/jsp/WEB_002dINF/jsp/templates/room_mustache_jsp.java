...
public final class room_mustache_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("       \t\t\t\t\t<label for=\"FormRoomType\">");
      ...
      if (_jspx_meth_s_text_3(_jspx_page_context))
        return;
      out.write(".\">*</sup></label>\n");
      out.write("                    \t<select name=\"id_roomType\">\n");
      out.write("\t\t\t\t\t\t\t{{#availableRoomTypes}}<option value=\"{{value_id}}\" {{#selected}}selected=\"selected\"{{/selected}}>{{value_name}}</option>{{/availableRoomTypes}}\n");
      out.write("\t\t\t\t\t\t</select>\n");
      out.write("      \t\t      \t</div> \n");
      out.write("\t\t\t\t  \t<div class=\"type-text\">\t\n");
      ...
      if (_jspx_meth_s_text_8(_jspx_page_context))
        return;
      out.write("</strong>\n");
      out.write("\t\t\t\t\t\t<span>{{roomType.name}}</span>\n");
      out.write("      \t\t      \t</div> \n");
      out.write("\t\t\t\t  \t<div class=\"type-text\">\t\n");
      out.write("                  \t\t<strong>");
      ...
      out.write("\t\t</form>\n");
      out.write("\t</script>\n");
      out.write("\t<script id=\"no-roomtype-template\" type=\"text/x-handlebars-template\">\n");
      out.write("\t\t<h3><strong>");
      ...
      if (_jspx_meth_s_property_0(_jspx_page_context))
        return;
      out.write("?sect=accomodation\"><img src=\"images/add-icon.png\" alt=\"");
      ...
      out.write("               \t</div>\n");
      out.write("               \t<div class=\"type-text\">           \n");
      out.write("       \t\t\t\t<label for=\"fFormType\">");
      if (_jspx_meth_s_text_17(_jspx_page_context))
        return;
      out.write("</label>\n");
      out.write("                   \t<input type=\"text\" name=\"roomType\" id=\"fFormType\" value=\"{{roomType}}\" aria-required=\"true\"/>\n");
      out.write("      \t\t    </div>\n");
      out.write("                <div class=\"type-button\">\n");
      ...
      out.write("\t\t{{#id}}<span class=\"title-elem\">{{image.caption}}</span><img src=\"");
  ...
  private boolean _jspx_meth_s_text_2(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_2.setName("roomType");
  ...
  private boolean _jspx_meth_s_text_8(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_8.setName("roomType");
  ...
  private boolean _jspx_meth_s_text_10(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_10.setName("roomTypesNotPresent");
  ...
  private boolean _jspx_meth_s_property_0(PageContext _jspx_page_context)
    ...
    _jspx_th_s_property_0.setValue("url_findallroomtypes");
  ...
  private boolean _jspx_meth_s_text_11(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_11.setName("roomType");
  ...
  private boolean _jspx_meth_s_text_12(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_12.setName("roomType");
  ...
  private boolean _jspx_meth_s_text_14(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_14.setName("roomType");
  ...
  private boolean _jspx_meth_s_text_15(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_15.setName("notes");
  ...
  private boolean _jspx_meth_s_text_16(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_16.setName("name");
  ...
  private boolean _jspx_meth_s_text_17(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_17.setName("roomType");
  ...
  private boolean _jspx_meth_s_text_18(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_18.setName("search");
  ...
  private boolean _jspx_meth_s_text_19(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_19.setName("facilityEdit");
  ...
  private boolean _jspx_meth_s_text_20(PageContext _jspx_page_context)
    ...
    _jspx_th_s_text_20.setName("editImages");
